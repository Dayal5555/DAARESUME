    ...
    try {
      ...
      if (data.success) {
        ...
        localStorage.setItem('userData', JSON.stringify({
          username: data.data?.user?.username || formData.name,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-8 lg:p-12">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-700">Join thousands of professionals building better resumes</p>
              </div>
              ...
              <div className="relative mb-8">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white text-gray-600">or sign up with email</span>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <input
                      className="h-4 w-4 text-teal-600 focus:ring-teal-500 border-gray-400 rounded mt-1"
                      id="terms"
                      name="terms"
                      type="checkbox"
                  ...
                  <div className="flex items-start">
                    ...
                    />
                    <label className="ml-3 block text-sm text-gray-700" htmlFor="newsletter">
                      Email me tailored resume advice & updates from Kickstart
                    </label>
                  </div>
                </div>
              ...
              <div className="mt-8 text-center">
                <p className="text-gray-700">
                  ...
                  <a className="font-semibold text-teal-600 hover:text-teal-700 transition-colors" href="/login">
                    Sign in
                  </a>
                </p>
              </div>
