...
const TemplatesPage: React.FC = () => {
  const [selectedTemplate, setSelectedTemplate] =
    useState<TemplateKey>('template-3');
  ...
  const templates: Template[] = [
    ...
    },
    {
      ...
      templateKey: 'template-3',
      description:
        'A professional and elegant design suitable for corporate roles.',
      component: ResumeTemplate3,
    },
    {
      id: '3',
      ...
      templateKey: 'template-3',
      description:
        'An elegant design with gold accents, perfect for engineering and technical roles.',
      component: ResumeTemplate3,
    },
  ];
  ...
  const currentTemplate = templates.find(
    t => t.templateKey === selectedTemplate
  );
            ...
            <div className='flex justify-center items-start'>
              <div className='a4-container'>
                {CurrentTemplateComponent && (
                  <CurrentTemplateComponent useSampleData={true} />
                )}
              </div>
            </div>
            ...
            <div className='mt-8 grid grid-cols-1 md:grid-cols-3 gap-6'>
              <div className='bg-white p-6 rounded-lg shadow'>
                ...
                <p className='text-gray-600 text-sm'>
                  Clean and modern layout that stands out to recruiters.
                </p>
              </div>
              <div className='bg-white p-6 rounded-lg shadow'>
                <h3 className='font-semibold text-gray-800 mb-2'>
