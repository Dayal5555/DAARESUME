...
const Education: React.FC<EducationProps> = ({ onComplete, onBack }) => {
  ...
  const handleAddEducation = () => {
    ...
    if (
      ...
      !validateDateFormat(currentEducation.startDate)
    ) {
      setDateErrors(prev => ({
        ...prev,
    ...
    if (
      ...
      !validateDateFormat(currentEducation.endDate)
    ) {
      setDateErrors(prev => ({
        ...prev,
        ...
        <div className='px-4 py-3'>
          ...
          <div className='space-y-4'>
            {pendingEducation.map(edu => (
              <div
                key={edu.id}
                className='border border-[#d0dbe7] rounded-xl p-4 bg-white'
              >
