...
const Skills: React.FC<SkillsProps> = ({ onComplete, onBack }) => {
  ...
  const [pendingSkills, setPendingSkills] = useState<Array<SkillForm & { id: string }>>([]);
    ...
    <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
      <div className="flex flex-wrap justify-between gap-3 p-4">
        <div className="flex min-w-72 flex-col gap-3">
          <p className="text-[#101418] tracking-light text-[32px] font-bold leading-tight">Skills</p>
          <p className="text-[#5c728a] text-sm font-normal leading-normal">Add your skills and proficiency levels</p>
        </div>
      </div>
      ...
      {pendingSkills.length > 0 && (
        <>
          ...
          {pendingSkills.map((skill) => (
            <div key={skill.id} className="flex items-center gap-4 bg-gray-50 px-4 min-h-[72px] py-2 justify-between">
      ...
      <div className="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
        <label className="flex flex-col min-w-40 flex-1">
          <p className="text-[#101418] text-base font-medium leading-normal pb-2">Skill *</p>
          <input
        ...
        <label className="flex flex-col min-w-40 flex-1">
          <p className="text-[#101418] text-base font-medium leading-normal pb-2">Proficiency *</p>
          <select
