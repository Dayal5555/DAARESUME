...
const TemplateSelection: React.FC = () => {
  ...
  return (
    <div className="bg-gray-100 text-center py-10 min-h-screen">
      <h1 className="text-4xl font-bold text-gray-800">Please select a template for your resume.</h1>
      <p className="text-xl text-gray-600 mt-2">You can always change it later.</p>
      
      <div className="flex justify-center mt-10 max-w-8xl mx-auto px-20">
        {templates.map((template) => (
          <div key={template.id} className="template-card flex flex-col items-center bg-[#e7ecf5] hover:bg-[#EAF5F2] p-6 rounded-lg">
            ...
            <h2 className="text-xl font-semibold text-gray-800 text-black mt-4 pb-3">{template.name}</h2>
            <button 
