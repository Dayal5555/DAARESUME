  ...
  const templates: Template[] = [
    {
      ...
      name: 'Sleek Modern',
      imageUrl:
        'https://lh3.googleusercontent.com/aida-public/AB6AXuBuEiohZAbOJLfp7YFkKhfvpkttPQKtSgiz3ie6Wgc3Q4lFq4dsHqDbzRfDV5VZAmBG17ZU_zfc9ojqi68TMmokYPQWBe58PCJFiJpve1pdLM1wB2O30jQbpmbi90g0gFUXAce-jdbg87ZtgFPosb6-FY79UyNsPUkIXY0sgV7TUC6qShEeCeZ3dXmyzSu_nVFpvewmrtzw80vr43_UJZ_vmiFUgdIzeocJcX1vRT7Od9Ssv3WlnYSpW4Rg9gZLFxi_4kxownAmFHs',
    ...
    },
    {
      ...
      imageUrl:
        'https://lh3.googleusercontent.com/aida-public/AB6AXuBWkaa_FwVYfq-00kFCzjNo2JtFqCY7lUuLE-x5v-fhRtkdhDTms_vWCfvbqQ3CBJeWsRcVdwGzlFGI7JXobTFIHLfmsx2bEdCcaB3oi-14wuiw_On5Trs--rPAwuheVp2kcUiql0K2Hxr46T_2W8GFubQEk4gB_zTgtHziEP0YS4iFOYxlZPHymHrKnTA5A9QNKHqjc2F1D0TUK0yg2yGaxnhi4TCuSAnP0na52f6f4YaECYpNfwa-lAcSiNCtBjgqK-a_ifsfxTw',
      ...
      <div className='layout-content-container flex flex-col max-w-[960px] flex-1 mx-auto pt-16'>
        <div className='flex flex-wrap justify-between gap-3 p-4'>
          <div className='flex min-w-72 flex-col gap-3'>
            ...
            <p className='text-[#4e7297] text-sm font-normal leading-normal'>
              Choose a template that best fits your professional background and
              career goals.
            </p>
          </div>
        </div>
        ...
        <div className='flex gap-3 p-3 flex-wrap pr-4'>
          {filters.map(filter => (
            ...
            >
              <p className='text-[#101418] text-sm font-medium leading-normal'>
                {filter}
              </p>
              <div
                ...
                <div className='absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-50 transition-all duration-300 rounded-xl flex items-center justify-center'>
                  <div className='opacity-0 group-hover:opacity-100 transition-opacity duration-300'>
                    <div className='bg-white rounded-lg shadow-lg'>
                      <p className='text-[#101418] text-sm font-semibold'>
                        Use This Template
                      </p>
                    </div>
                  </div>
